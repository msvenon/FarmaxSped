...
type
  TdmPrincipal = class(TDataModule)
    ...
    FDMemTBCST50: TFDMemTable;
    FDMemTBCST50valorBC: TFloatField;
    FDMemTBCST50valorPis: TFloatField;
    FDMemTBCST50valorCofins: TFloatField;
    cdsRegC170NFID: TIntegerField;
    cdsRegC170NUM_ITEM: TStringField;
    cdsRegC170COD_ITEM: TStringField;
    cdsRegC170DESCR_COMPL: TStringField;
    cdsRegC170QTD: TFloatField;
    cdsRegC170UNID: TStringField;
    cdsRegC170VL_ITEM: TFloatField;
    cdsRegC170VL_DESC: TFloatField;
    cdsRegC170IND_MOV: TIntegerField;
    cdsRegC170CST_ICMS: TStringField;
    cdsRegC170CFOP: TStringField;
    cdsRegC170COD_NAT: TStringField;
    cdsRegC170VL_BC_ICMS: TFloatField;
    cdsRegC170ALIQ_ICMS: TFloatField;
    cdsRegC170VL_ICMS: TFloatField;
    cdsRegC170VL_BC_ICMS_ST: TFloatField;
    cdsRegC170ALIQ_ST: TFloatField;
    cdsRegC170VL_ICMS_ST: TFloatField;
    cdsRegC170IND_APUR: TIntegerField;
    cdsRegC170CST_IPI: TStringField;
    cdsRegC170COD_ENQ: TStringField;
    cdsRegC170VL_BC_IPI: TFloatField;
    cdsRegC170ALIQ_IPI: TFloatField;
    cdsRegC170VL_IPI: TFloatField;
    cdsRegC170CST_PIS: TStringField;
    cdsRegC170VL_BC_PIS: TFloatField;
    cdsRegC170ALIQ_PIS_PERC: TFloatField;
    cdsRegC170QUANT_BC_PIS: TFloatField;
    cdsRegC170ALIQ_PIS_R: TFloatField;
    cdsRegC170VL_PIS: TFloatField;
    cdsRegC170CST_COFINS: TStringField;
    cdsRegC170VL_BC_COFINS: TFloatField;
    cdsRegC170ALIQ_COFINS_PERC: TFloatField;
    cdsRegC170QUANT_BC_COFINS: TFloatField;
    cdsRegC170ALIQ_COFINS_R: TFloatField;
    cdsRegC170VL_COFINS: TFloatField;
    cdsRegC170COD_CTA: TStringField;
    FDConsTemReg0200: TFDQuery;
    dspConsReg0200: TDataSetProvider;
    cdsConsTempReg0200: TClientDataSet;
    cdsConsTempReg0200CODIGO_ITEM: TFloatField;
